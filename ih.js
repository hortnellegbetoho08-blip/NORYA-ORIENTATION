...
const ecoles = {
  "Université d’Abomey-Calavi": {
    "Institut Régional de Santé Publique (IRSP)": [{
      ...
      debouches: ["Agent de santé communautaire", 
    ...
    "Faculté des Lettres, Arts et Sciences Humaines-Adjarra (FLASH-Adjarra)": [{
      filiere: "Géographie et Aménagement du Territoire",
      quotas: "Bourse: 60  Aide: 340",
      modeEntree: "Classement",
      bacRecommande: ["A1", "A2", "B", "C", "D", "DT/STI", "DEAT"],
      matieresParSerie: {
        "A1": ["Français", "Histoire-Géo", "Mathématiques"],
        "A2": ["Français", "Histoire-Géo", "Mathématiques"],
        "B": ["Français", "Histoire-Géo", "Mathématiques"],
        "C": ["Français", "Histoire-Géo", "Mathématiques"], 
        "D": ["Français", "Histoire-Géo", "Mathématiques"],
        "DT/STI": ["Français", "Anglais", "Mathématiques"],
        "DEAT": ["Français", "Histoire-Géo", "Mathématiques"] 
      },
      ...
      debouches: ["Agent dans les centres sociaux", 
        "Ministères, Recherche"]
    }, {
      filiere: "Anglais",
      quotas: "Bourse: 134  Aide: 667",
      modeEntree: "Classement",
      bacRecommande: ["A1", "A2", "B", "C", "D", "DT/STI", "DEAT"],
      matieresParSerie: {
         "A1": ["Français", "Histoire-Géo", "Anglais"],
        "A2": ["Français", "Histoire-Géo", "Anglais"],
        "B": ["Français", "Histoire-Géo", "Anglais"],
        "C": ["Français", "Histoire-Géo", "Anglais"], 
        "D": ["Français", "Histoire-Géo", "Anglais"],
        "DT/STI": ["Français", "Anglais", "Mathématiques"],
        "DEAT": ["Français", "Histoire-Géo", "Anglais"]
      },
